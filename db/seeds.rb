...
t1_customer1 = T1Customer.create(email: 'terminal1@test.as', name: 'Terminal1')
t1_customer2 = T1Customer.create(email: 't1_customer2@test.as', name: 'N&K')
t1_customer3 = T1Customer.create(email: 't1_customer3@test.as', name: 'CERMAQ')
t1_customer4 = T1Customer.create(email: 't1_customer4@test.as', name: 'INTERCARGO')
t1_customer5 = T1Customer.create(email: 't1_customer5test.as', name: 'POLAR QUALITY')
puts "T1 Customer  = #{T1Customer.count}"
